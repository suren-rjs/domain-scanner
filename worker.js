...
// Configure Axios with a 10s timeout, realistic browser headers, and custom HTTPS agent
const client = axios.create({
  ...
  httpsAgent: new https.Agent({
    rejectUnauthorized: false, // Prevents certificate verification errors from breaking the scan
    keepAlive: true,
  }),
